        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              {/* Founder Info */}
              <div className="bg-gradient-orange text-white rounded-3xl p-8 shadow-2xl mb-8">
                <h3 className="text-2xl font-bold mb-6">Founder</h3>
                <div className="space-y-4">
                  <p className="text-2xl font-bold">Lashika Vithanage</p>
                  <div className="flex items-center text-lg">
                    <span className="mr-3 text-2xl">📞</span>
                    <a
                      href="tel:+94777725339"
                  ...
                  <div className="flex items-center text-lg">
                    <span className="mr-3 text-2xl">📧</span>
                    <a
                      href="mailto:hello@1000women.lk"
                      className="hover:text-gray-200 transition-colors"
                    >
                      hello@1000women.lk
                    </a>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl">
                <h3 className="text-2xl font-bold text-orange-primary mb-6">
                  Follow Us on Social Media
                </h3>
                <p className="text-lg text-gray-600 mb-6">@1000Women</p>
                <div className="flex space-x-4">
                  <motion.a
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    href="https://www.facebook.com/1000Women"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gradient-orange text-white p-4 rounded-full hover:shadow-xl transition-all"
                  >
                  ...
                  <motion.a
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    href="https://www.instagram.com/1000Women"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gradient-orange text-white p-4 rounded-full hover:shadow-xl transition-all"
                  >
                  ...
                  <motion.a
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    href="https://www.linkedin.com/company/1000Women"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gradient-orange text-white p-4 rounded-full hover:shadow-xl transition-all"
                  >
                  ...
                  <motion.a
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    href="https://twitter.com/1000Women"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gradient-orange text-white p-4 rounded-full hover:shadow-xl transition-all"
                  >
